...
from .logsignature_module import (
...
from . import (
    unstable,
)  # make it available as an attribute here, but don't import any unstable objects themselves
from .utility import lyndon_words, lyndon_brackets, all_words
